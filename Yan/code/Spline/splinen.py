...
def CalculateAMatrix(x,order):
    ...
    paremeter.append(data)
    paremeter.append(data1)
    #print ('after 2 paremeter shape is : ', len(paremeter))   
    # 根据约束3：  
    i = 1
    '''
    while  i <SizeOfX:
    ...
    while  i <SizeOfX:
        ...
        #构建x矩阵及系数矩阵
            ...
            j += 1
        i = i+1
    #print ('after 3 paremeter shape is : ', len(paremeter))   
    # 根据约束4：   
    data = np.zeros((n * (SizeOfX)))
    data[n-1]=1;
    paremeter.append(data)  
    
    #print ('after 4 paremeter shape is : ', len(paremeter))   
